...
- Каталог: дворівневі категорії обох закладів → товари, розкладені по секціях →
  картка з варіантами розмірів і цін
- Опції «на вибір»: соус до картоплі, напій до боксу, соуси до хенд-ролів.
  Скільки саме позицій брати, задається на звʼязку товару з групою, тож та сама
  група для хенд-рола означає «1 з 3», а для СЕТу — «усі 3»
- Стоп-лист: товар або окремий розмір ховається з меню без видалення з БД
- Кошик: додавання, зміна кількості, видалення позиції, повне очищення.
  Одна позиція з різними опціями — різні рядки кошика
- Контакти закладів
...
опцій і кількості, кошик, контакти. Нативна кнопка «Назад», тактильний відгук,
світла й темна теми Telegram.
