...
> **Статус: Фази 1–3 та розширення адміністрування реалізовані.** Бекенд, бот, інфраструктура, каталог,
> мультилокаційний кошик, чекаут (доставка/самовивіз зі збереженими адресами), історія замовлень
> із повтором у клік, інтерактивне керування замовленнями у боті, верифікація номера телефону
> та повнофункціональна адмін-панель готові.
...
5 | Push-нотифікації статусів, адмін-панель | 🟡 частково готово (адмінка та нотифікації діють)
