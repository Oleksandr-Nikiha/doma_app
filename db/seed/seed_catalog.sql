...
-- --- Категорії ---
INSERT INTO categories (location_id, name, icon, sort_order)
SELECT id, 'Піца', '🍕', 1 FROM locations WHERE name = 'Doma Pizza'
UNION ALL
SELECT id, 'Суші та роли', '🍣', 2 FROM locations WHERE name = 'Doma Pizza'
UNION ALL
SELECT id, 'Боули та салати', '🥗', 3 FROM locations WHERE name = 'Doma Pizza'
UNION ALL
SELECT id, 'Закуски', '🍟', 4 FROM locations WHERE name = 'Doma Pizza'
UNION ALL
SELECT id, 'Десерти', '🍰', 5 FROM locations WHERE name = 'Doma Pizza'
UNION ALL
SELECT id, 'Напої', '🥤', 6 FROM locations WHERE name = 'Doma Pizza'
UNION ALL
SELECT id, 'Круасани', '🥐', 1 FROM locations WHERE name = 'Doma Croissants';
...
WITH new_product AS (
    ...
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Чотири сири', 'Тонке тісто, сир моцарела, соус вершковий, сир Дор-Блю, сир Чедер, сир Пармезан, базилік, прованські трави.',
           'https://domapizza.com.ua/wp-content/uploads/4Сира-400x400.webp', 7
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Чотири м’яса', 'Тонке тісто, сир моцарела, соус томатний, ковбаски єгерські, філе курки, бекон, шинка, печериці, солоний огірок, прованські трави.',
           'https://domapizza.com.ua/wp-content/uploads/4Мяса-400x400.webp', 8
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Чотири океани', 'Тонке тісто, сир моцарела, соус вершковий, маслини, сир Пармезан, базилік, креветка, філе тунця, філе лосося свіже та молосолоне, м’ясо мідії, прованські трави.',
           'https://domapizza.com.ua/wp-content/uploads/4Океани-400x400.webp', 9
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Філадельфія', 'Тонке тісто, сир моцарела, соус вершковий, сир Пармезан, базилік, філе лосося свіже та молосолоне, руккола, прованські трави.',
           'https://domapizza.com.ua/wp-content/uploads/Філадельфія-400x400.webp', 10
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'А-ля Карбонара', 'Тонке тісто, сир моцарела, соус Вершковий, бекон, цибуля Порей, помідори, сир Пармезан',
           'https://domapizza.com.ua/wp-content/uploads/Карбонара-400x400.webp', 11
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'А-ля Капричоза', 'Тонке тісто, сир моцарела, соус томатний, шинка, гриби печериці, помідори, перець, комбінація фірмових спецій, соус солодкий чілі',
           'https://domapizza.com.ua/wp-content/uploads/Капричоза-400x400.webp', 12
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Мюнхенська', 'Тонке тісто, сир моцарела, соус з томатів Пілаті, шинка, охотнічі ковбаски, Мюнхенські ковбаски, помідори, комбінація фірмових спецій, гірчиця Американська.',
           'https://domapizza.com.ua/wp-content/uploads/Мюнхінька-400x400.webp', 13
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Кантрі', 'Тонке тісто, сир моцарела, соус томатний, цибуля солодка, бекон, шинка, огірок, маслини, цибулька зелена.',
           'https://domapizza.com.ua/wp-content/uploads/Кантр-400x400.webp', 14
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Гавайська', 'Тонке тісто, сир моцарела, соус томатний, вершки, філе курки, кукурудза, шинка, ананас.',
           'https://domapizza.com.ua/wp-content/uploads/Гавайська-400x400.webp', 15
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Фреш', 'Тонке тісто, сир моцарела, соус томатний, цибуля солодка, печериці, кукурудза, помідор, перець солодкий',
           'https://domapizza.com.ua/wp-content/uploads/Фреш-1-400x400.webp', 16
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Цезар', 'Тонке тісто, сир моцарела, соус Цезарь, копчена курка, бекон, помідори, листя ромена, сир Пармезан',
           'https://domapizza.com.ua/wp-content/uploads/Цезар-400x400.webp', 17
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'El Diablo (Ель Д’ябло)', 'Тонке тісто, сир моцарела, соус томатний, ковбаса салямі, ковбаски єгерські, перець халапеньо, соус чілі.',
           'https://domapizza.com.ua/wp-content/uploads/ЕльДьябло-400x400.webp', 18
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Honey Meat (Ханей Міт)', 'Тонке тісто, сир моцарела, соус томатний, ковбаса салямі, шинка, сир ДорБлю, Сир Пармезан, руккола, фірмовий медовий соус.',
           'https://domapizza.com.ua/wp-content/uploads/ХаниМит-400x400.webp', 19
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Американо', 'Тонке тісто, сир моцарела, соус з томатів Пілаті, картопля фрі з печі, ХотДог ковбаски, сир Пармезан, комбінація спецій, соус фармовий томатний',
           'https://domapizza.com.ua/wp-content/uploads/Американо-400x400.webp', 20
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Let’s Bianco (Летс Б’янко)', 'Тонке тісто, сир моцарела, соус вершковий, фірмове філе курки, печериці, помідори, сир Пармезан, фірмова комбінація спецій.',
           'https://domapizza.com.ua/wp-content/uploads/Лецбьянка-400x400.webp', 21
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Медова груша', 'Тонке тісто, сир моцарела, соус вершковий, сир ДорБлю, груша, горіх Волоський, мед, гострий перець',
           'https://domapizza.com.ua/wp-content/uploads/Грушка-400x400.webp', 22
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Маргарита', 'Тонке тісто, сир моцарела, соус томатний, помідори, сир Пармезан',
           'https://domapizza.com.ua/wp-content/uploads/Маргорита-400x400.webp', 23
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Салямі', 'Тонке тісто, сир моцарела, соус томатний, ковбаса салямі',
           'https://domapizza.com.ua/wp-content/uploads/Пеперони-400x400.webp', 24
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'BBQ', 'Тонке тісто, сир моцарела, соус BBQ, солодка цибуля, ковбаски єгерські, філе курки, печериці, кукурудза, перець солодкий',
           'https://domapizza.com.ua/wp-content/uploads/BBQ-400x400.webp', 25
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Піца'
    RETURNING id
)
...
-- ========== Суші та роли (52 позицій) ==========

WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Хенд -рол з лососем', 'Соуса на вибір- БЕЗКОШТОВНО Гостро-солодкий, Спайсі, Унагі',
           'https://domapizza.com.ua/wp-content/uploads/Хенд-рол-з-лососем-400x400.webp', 1
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
INSERT INTO product_variants (product_id, label, weight, price, sort_order)
SELECT new_product.id, v.label, v.weight, v.price, v.sort_order
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Хенд – рол з вугрем', 'Соус на вибір- БЕЗКОШТОВНО Гостро-солодкий, Спайсі, Унагі',
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Хенд – рол з тигровою креветкою', 'Соус на вибір- БЕЗКОШТОВНО Гостро-солодкий, Спайсі, Унагі',
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Хенд – рол СЕТ', 'Хенд – рол з лососсем, Хенд – род з вугрем, Хенд – рол з тигровою креветкою (Три соуса на вибір- БЕЗКОШТОВНО Гостро-солодкий, Спайсі, Унагі)',
...
WITH new_product AS (
    ...
    SELECT c.id, 'nOLiveAs… рол', 'Рис, норі, філе лосося смажене, філе лосося свіже, помідор, авокадо, салат айсберг, соусоус унагі',
           'https://domapizza.com.ua/wp-content/uploads/2024/05/IMG_3841-400x400.jpg', 5
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Asamo рол', 'Рис, сир филадельфия, норі, філе лосося смажене, мідії, огірок, помідор, соус солодкий Чілі',
           'https://domapizza.com.ua/wp-content/uploads/2024/05/2024-05-10-09.41.09-500x428.jpg', 6
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Margo&Rita рол', 'Рис, норі, філе тунця, мідії, авокадо, огірок, чука, горіхова-кунжутний соус',
           'https://domapizza.com.ua/wp-content/uploads/2024/05/IMG_3842-400x400.jpg', 7
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Супер філадельфія сет', 'Рол філадельфія лосось, Рол філадельфія тунець Рол філадельфія вугор, Рол філадельфія креветка, Рол філадельфія авокадо (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2023/05/супер-філа-сет-400x400.png', 8
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, '50/50 сет', 'Рол філадельфія вугор, Рол філадельфія креветка, Рол каліфорнія тунець,Рол каліфорнія лосось (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2023/05/філакаліфа-сет-400x400.png', 9
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Супе МакіСЕТ', 'СуперМакі Лосось рол, СупеМакі Вугор рол, СуперМакі Тунець рол, СуперМакі Тигрова Креветка рол, СупеМАкі Авокадо рол.',
           'https://domapizza.com.ua/wp-content/uploads/2025/01/IMG_4901.PNG-400x400.png', 10
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Супер дракон сет', 'Рол золотий дракон, Рол червоний дракон, Рол зелений дракон,Рол тигровий дракон, Рол білий дракон (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2023/05/скпер-дракон-сет-400x400.png', 11
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Супер Лосось сет', 'Рол філадельфія лосось, Рол червоний дракон, Рол каліфорнія лосось в ікрі тобіко, Рол леопард чіз (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2023/06/лосось-сет-400x400.jpg', 12
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Філадельфія сет', 'Філадельфія лосось, Філадельфія тунец, Філадельфія вугорь (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/filadelfiia-set-1-400x400.jpg', 13
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Каліфорнія сет', 'Каліфорнія тобіка лосось, Каліфорнія тобіка тунец, Каліфорнія вугорь, Каліфорнія креветка (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/kaliforniia-set-400x400.jpg', 14
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Дракон сет', 'Дракон Золотий, Дракон Зелений, Дракон Червоний (Склад ролів зазанчено нижче до кожного рола окремо)ʼ',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/drakon-set-400x400.jpg', 15
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Макі сет', 'Макі лосось, Макі тунец, Макі вугорь, Макі креветка, Макі Огірок (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/maki-set-2-400x400.jpg', 16
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Запечений сет (НОВИЙ – 4 роли)', 'Рол Запечений лосось, Рол Запечений вугорь, Рол Запечена креветка, Рол Запевений тунець (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2022/01/IMG_7979-400x400.jpg', 17
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'DomaFresh (ДомаФреш)', 'Рол ФрешЛайф, Рол ФрешРед, Рол ФрешБоніто (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2021/07/photo_2021-07-28_18-42-31-400x400.jpg', 18
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Спрінг чіз', 'Рол Леопард чіз, Рол Тигр чіз, Рол Пантера чіз (Склад ролів зазанчено нижче до кожного рола окремо)',
           'https://domapizza.com.ua/wp-content/uploads/2023/04/4-400x400.png', 19
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Vікторія сет', 'Рол Asamo, Рол nOLiveAs, Рол Margi&Rita',
           'https://domapizza.com.ua/wp-content/uploads/2024/12/IMG_4807-400x400.jpg', 20
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Леопард чіз', 'Рис, сир филадельфия, норі, груша, філе тунецю, сир Чедр, філе лосося, соус солодкий чілі',
           'https://domapizza.com.ua/wp-content/uploads/2023/04/2-400x400.png', 21
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Тигр чіз', 'Рис, сир филадельфия, норі, груша, креветка тигрова, сир Чедр, філе тунця, соус Унагі, кранч цибуля',
           'https://domapizza.com.ua/wp-content/uploads/2023/04/1-400x400.png', 22
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Пантера чіз', 'Рис, сир филадельфия, норі, груша, сир Чедр, вугорь, унагі соус, кунжут',
           'https://domapizza.com.ua/wp-content/uploads/2023/04/3-400x400.png', 23
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Запечений лосось', 'Філе лосося, норі, рис, сир філадельфія, авокадо, икра, сирная шапочка (сир, майонез)',
           'https://domapizza.com.ua/wp-content/uploads/2022/01/IMG_7739-400x400.jpg', 24
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Запечений вугорь', 'Вугорь, норі. рис, сир філадельфія, кунжут, авокадо, сирная шапочка (сир, майонез), соус Унагі',
           'https://domapizza.com.ua/wp-content/uploads/2022/01/IMG_7899-400x400.jpg', 25
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Запечена креветка', 'Креветка, норі, рис, сир філадельфія, авокадо, ікра, сирная шапочка (сир, майонез)',
           'https://domapizza.com.ua/wp-content/uploads/2022/01/IMG_7871-400x400.jpg', 26
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Запечений тунець', 'Тунець, норі, рис, сир філадельфія, авокадо, стружка тунця, сирная шапочка (сир, майонез)',
           'https://domapizza.com.ua/wp-content/uploads/2022/05/20220503-DSC_0009-400x400.jpg', 27
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'FreshLife (ФрешЛайф)', 'Рис, сир филадельфия, гриб шитакі, чука, огірок, кунжутне насіння',
           'https://domapizza.com.ua/wp-content/uploads/2021/07/3333333-400x400.jpg', 28
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'FreshRed (ФрешРед)', 'Рис, сир филадельфия, чука, філе лосося, філе тунця, ікра тобіко, кунжутне насіння',
           'https://domapizza.com.ua/wp-content/uploads/2021/07/1-400x400.jpg', 29
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'FreshBonito (ФрешБоніто)', 'Рис, сир филадельфия, чука, филе лосося, стружка тунця',
           'https://domapizza.com.ua/wp-content/uploads/2021/07/2-400x400.jpg', 30
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Філадельфія лосось', 'Рис, сир филадельфия, огірок, филе лосося',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/fylodelfyia-s-lososem-1-400x400.jpg', 31
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Філадельфія тунец', 'Рис, сир филадельфия, огірок, филе тунеця, кунжут, цибуля зелена',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/fyladelfyia-s-tuntsom-400x400.jpg', 32
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Філадельфія вугорь', 'Рис, сир филадельфия, огірок, вугорь, кунжут, унагі соус, цибуя суха',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/felodelfyia-s-uhrem-400x400.jpg', 33
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Філадельфія креветка', 'Рис, сир филадельфия, огірок, креветка тігрова, соус солодкий чілі, цибуля суха',
           'https://domapizza.com.ua/wp-content/uploads/2022/05/20220503-DSC_0004-400x400.jpg', 34
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Каліфорнія лосось', 'рис, сир филадельфия, філе лосося, огірок, авокадо, кунжут',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/kaliforniia-losos-1-400x400.jpg', 35
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Каліфорнія тунец', 'рис, сир филадельфия, філе тунця, огірок, авокадо, кунжут',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/kaliforniia-z-tuntsem-1-400x400.jpg', 36
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Каліфорнія вугорь', 'рис, сир филадельфия, вугор, огірок, авокадо, кунжут, унагі соус',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/kaliforniia-z-vuhrem-1-400x400.jpg', 37
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Каліфорнія креветка', 'рис, сир филадельфия, креветка, огірок, авокадо, кунжут',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/kaliforniia-z-krevetkoiu-2-400x400.jpg', 38
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Макі лосось', NULL,
           'https://domapizza.com.ua/wp-content/uploads/2021/03/maki-z-lososem-1-400x400.jpg', 39
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Макі тунец', NULL,
           'https://domapizza.com.ua/wp-content/uploads/2021/03/maki-z-tuntsem-1-400x400.jpg', 40
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Макі вугорь', 'рис, огірок, вугор, кунжут, унагі соус',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/maki-z-vuhrem-1-400x400.jpg', 41
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Макі креветка', NULL,
           'https://domapizza.com.ua/wp-content/uploads/2021/03/maki-krevetka-1-400x400.jpg', 42
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Макі Огірок', 'рис, огірок, кунжут, унагі соус',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/maki-z-ohirkom-400x400.jpg', 43
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Окінава', 'рис, сир філадельфія, шитакі, креветка, вугорь, ікра тобіко, унагі соус, кунжут, суха цибля',
           'https://domapizza.com.ua/wp-content/uploads/2021/06/okinava-400x400.jpg', 44
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Футомакі', 'рис,сир філадельфія,лосось,вугорь,авокадо, ікра тобіко, огірок',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/futomaki-400x400.jpg', 45
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'DomaMaguro (ДомаМагуро)', 'рис, сир філадельфія, тунець запечений, цибуля зелена, огірок, ікра тобіко',
           'https://domapizza.com.ua/wp-content/uploads/2021/07/photo_2021-07-15_14-41-30-400x400.jpg', 46
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Салат Хіяши Вакаме', 'кунжут, фірмовий горіховий соус, водорослі чука',
           'https://domapizza.com.ua/wp-content/uploads/2021/10/2361545170_w600_h600_2361545170-400x400.jpg', 47
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Дракон Золотий', 'рис, сир філадельфія, вугор,лосось, токуан, гриб шиитаке, ікра тобіко, унагі сосус, кунжут, цибуля суха',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/drakon-zolotyi-400x400.jpg', 48
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Дракон Зелений', 'рис, сир філадельфія, вугор, авокадо, ікра тобіко, огірок, кунжут, унагі соус, цибуля суха',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/drakon-zelenyi-1-400x400.jpg', 49
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Дракон Червоний', 'рис, вугор, лосось, огірок, токуан',
           'https://domapizza.com.ua/wp-content/uploads/2021/03/drakon-chervonyi-1-400x400.jpg', 50
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Дракон Тигровий', 'рис, креветка, лосось, авокадо, ікра тобіко, сир філадельфія, соус солодкий чілі, суха цибуля',
           'https://domapizza.com.ua/wp-content/uploads/2022/05/20220503-DSC_0007-400x400.jpg', 51
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Дракон Білий', 'рис, креветка, лосось, авокадо, ікра тобіко, сир філадельфія, сир тестовий чедр, соус унагі',
           'https://domapizza.com.ua/wp-content/uploads/2024/12/IMG_4808-400x400.png', 52
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Суші та роли'
    RETURNING id
)
...
WITH new_product AS (
    ...
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Боули та салати'
    RETURNING id
)
INSERT INTO product_variants (product_id, label, weight, price, sort_order)
SELECT new_product.id, v.label, v.weight, v.price, v.sort_order
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Картоплая фрі з печі', 'Картопля, комбінація спецій, сіль, соус на вибір (кетчуп або сирний в діп)',
           'https://domapizza.com.ua/wp-content/uploads/Картопля-1-400x400.webp', 1
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
INSERT INTO product_variants (product_id, label, weight, price, sort_order)
SELECT new_product.id, v.label, v.weight, v.price, v.sort_order
...
WITH new_product AS (
    ...
    SELECT c.id, 'Чікен рол', 'Тартилья, Курячі нагетси, салат Асберг, помідор, соус фірмовий',
           'https://domapizza.com.ua/wp-content/uploads/Чікен-рол-400x400.webp', 2
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Чікен рол бокс', 'Чікен рол, картопля фрі з печі, напій (Соус до картоплі, Кола, Фанта, Спрайт 0.5 л на вибір – безкоштовно)',
           'https://domapizza.com.ua/wp-content/uploads/Чікен-рол-бокс-400x400.webp', 3
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Верона рол', 'Тартилья, Салямі, Шинка, Філе куряче, Моцарела, Цибуля, Чедр, Фірмовий соус, комбінація фірмових спецій',
           'https://domapizza.com.ua/wp-content/uploads/Верона-рол-400x400.webp', 4
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Верона рол бокс', 'Верона рол, картопля фрі з печі, напій (Соус до картоплі, Кола, Фанта, Спрайт 0.5 л на вибір – безкоштовно)',
           'https://domapizza.com.ua/wp-content/uploads/Верона-рол-бокс-400x400.webp', 5
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Вишгородський рол', 'Тартилья, Бекон, Халапеньо, Моцарела, Фірмоуий соус, комбінація фірмових спецій',
           'https://domapizza.com.ua/wp-content/uploads/Вишгородський-рол-400x400.webp', 6
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Вишгоордський рол бокс', 'Вишгородський рол, картопля фрі з печі, напій (Соус до картоплі, Кола, Фанта, Спрайт 0.5 л на вибір – безкоштовно)',
           'https://domapizza.com.ua/wp-content/uploads/Вишгородський-рол-бокс-400x400.webp', 7
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Цезар рол', 'Тартилья, Бекон, Філе куряче, Помідор, Моцарела, Фірмовий соус Цезар, Комбінація фірмових спецій',
           'https://domapizza.com.ua/wp-content/uploads/Цезарь-рол-400x400.webp', 8
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Цезар рол бокс', 'Цезар рол, картопля фрі з печі, напій (Соус до картоплі, Кола, Фанта, Спрайт 0.5 л на вибір – безкоштовно)',
           'https://domapizza.com.ua/wp-content/uploads/Цезарь-рол-бокс-400x400.webp', 9
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Хані міт роллінг', 'Тартилья, Салямі, Шинка, Рукола, Крем сир,Моцарела, Пармезан, Дор-Блю, Фірмовий соус Медово-гірчичний',
           'https://domapizza.com.ua/wp-content/uploads/Хані-міт-роллінг-400x400.webp', 10
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Хані міт роллінг бокс', 'Хані кіт роллинг, картопля фрі з печі, напій (Соус до картоплі, Кола, Фанта, Спрайт 0.5 л на вибір – безкоштовно)',
           'https://domapizza.com.ua/wp-content/uploads/Хані-міт-роллінг-бокс-400x400.webp', 11
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Фокачі Вишгородський (гострий)', 'Тонке фірмове тісто, сир Моцарелла. бекон, перець халапеньо, сирна пікнтна приправа',
           'https://domapizza.com.ua/wp-content/uploads/2023/04/коржик-вишг-400x400.png', 12
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Фокачі Мюнхенський', 'Тонке фірмове тісто, сир Моцарелла. Ковбаски мисливські. Ковбаски Мюгнхенські. гірчиця, сирна пікантна приправа',
           'https://domapizza.com.ua/wp-content/uploads/2023/04/коржик-мюнх-400x400.png', 13
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Закуски'
    RETURNING id
)
...
WITH new_product AS (
    ...
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Десерти'
    RETURNING id
)
INSERT INTO product_variants (product_id, label, weight, price, sort_order)
SELECT new_product.id, v.label, v.weight, v.price, v.sort_order
...
WITH new_product AS (
    ...
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Напої'
    RETURNING id
)
INSERT INTO product_variants (product_id, label, weight, price, sort_order)
SELECT new_product.id, v.label, v.weight, v.price, v.sort_order
...
WITH new_product AS (
    ...
    SELECT c.id, 'Швепс', NULL,
           'https://domapizza.com.ua/wp-content/uploads/Gemini_Generated_Image_h9e5hvh9e5hvh9e5-400x400.webp', 2
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Напої'
    RETURNING id
)
...
WITH new_product AS (
    ...
    SELECT c.id, 'Сік', NULL,
           'https://domapizza.com.ua/wp-content/uploads/Gemini_Generated_Image_fjhv4gfjhv4gfjhv-400x400.webp', 3
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Напої'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Cola, Fanta, Sprite', NULL,
           'https://domapizza.com.ua/wp-content/uploads/Gemini_Generated_Image_6zmplu6zmplu6zmp-400x400.webp', 4
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Напої'
    RETURNING id
)
...
WITH new_product AS (
    INSERT INTO products (category_id, name, description, image_url, sort_order)
    SELECT c.id, 'Вода мінеральна', 'Надшвидка доставка до 30* хв.',
           'https://domapizza.com.ua/wp-content/uploads/bonaqua-drink-2-400x400.webp', 5
    FROM categories c JOIN locations l ON l.id = c.location_id
    WHERE l.name = 'Doma Pizza' AND c.name = 'Напої'
    RETURNING id
)
