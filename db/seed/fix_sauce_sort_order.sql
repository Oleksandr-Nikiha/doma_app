...
-- Разовий фікс для БД, куди «Сирний» і «BBQ» додавали вручну повз сид.
--
...
-- (Кетчуп, Сирний і BBQ усі мали 1). Postgres не гарантує порядок рядків
...
--
-- Цільовий порядок: Кетчуп, Сирний соус, Сирний, BBQ.
--
